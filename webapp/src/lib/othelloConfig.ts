...
export const BLACK_PIECE_COLOR = 'rgba(32, 32, 32, 1)';
export const INNER_BLACK_COLOR = 'rgba(44, 44, 44, 1)';
export const WHITE_PIECE_COLOR = 'rgba(238, 238, 238, 1)';
export const INNER_WHITE_COLOR = 'rgba(255, 255, 255, 1)';
