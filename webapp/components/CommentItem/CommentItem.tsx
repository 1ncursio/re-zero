...
const CommentItem: FC<CommentItemProps> = ({ comment }) => {
  ...
  return (
    <div key={comment.id} className="flex gap-2">
      <img
        src={optimizeImage(comment.user?.image_url ?? '/assets/images/user_thumbnail.png')}
        alt="user"
      ...
      <div className="flex-1">
        ...
        {comment.reply_count > 0 && (
          ...
          >
            {isOpenReply
              ? /* <Icon name="outlinedUpArrow" className="w-4 h-4" fill="none" stroke="currentColor" /> */ 'outlinedUpArrow'
              : /* <Icon name="outlinedDownArrow" className="w-4 h-4" fill="none" stroke="currentColor" /> */ 'outlinedDownArrow'}
